		...
		cssmin: {
			style: {
				...
				files: {
					...
					'core/includes/customizer/assets/min/css/button-presets.min.css':'core/includes/customizer/controls/buttonpresets/button-presets.css',
					'core/includes/customizer/assets/min/css/color.min.css':'core/includes/customizer/controls/color/color.css',
					'core/includes/customizer/assets/min/css/color-states.min.css':'core/includes/customizer/controls/color-states/color-states.css',
					...
					'core/includes/customizer/assets/min/css/range.min.css':'core/includes/customizer/controls/range/range.css',
					'core/includes/customizer/assets/min/css/section-toggle.min.css':'core/includes/customizer/controls/section-toggle/section-toggle.css',
				}
			}
		},
