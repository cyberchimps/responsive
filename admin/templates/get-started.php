...
<div class="responsive-theme-getting-started-page-notification text-center">
	<p>📣 <?php esc_html_e( 'Introducing the Site Builder in Responsive Starter Templates v3.3.0! Now you can easily create custom Headers, Footers, and 404 Pages. Display them based on specific page or time conditions. Update the Responsive theme to v6.2.2 and unlock the new Site Builder features.', 'responsive' ); ?> <a href="<?php echo esc_url( 'https://wordpress.org/plugins/responsive-add-ons/#developers' )?>" target="_blank"><?php esc_html_e( 'Check Changelog', 'responsive' ); ?></a></p>
</div>
