...
if (!class_exists('Responsive_Woocommerce')) :
    ...
    class Responsive_Woocommerce
    {
        ...
        function responsive_shop_js_localize()
        {
            ...
            wp_enqueue_script('responsive-shop-pagination-infinite', get_stylesheet_directory_uri() . '/core/' . $directory . '/product-pagination-infinite' . $suffix . '.js', array(
                'jquery',
                'wp-util'
            ), '3.17.2', true);
            ...
            $localize['shop_no_more_post_message'] = apply_filters('responsive_blog_no_more_post', __('No more posts to show.', 'responsive'));
