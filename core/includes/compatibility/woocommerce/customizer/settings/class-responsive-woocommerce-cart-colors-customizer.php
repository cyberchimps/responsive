...
if ( ! class_exists( 'Responsive_Woocommerce_Cart_Colors_Customizer' ) ) :
	...
	class Responsive_Woocommerce_Cart_Colors_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_color_control( $wp_customize, 'cart_buttons', $cart_buttons_label, 'responsive_woocommerce_cart', 20, '#10659C' );

			// Button Text.
			$cart_buttons_text_label = __( 'Button Text', 'responsive' );
			responsive_color_control( $wp_customize, 'cart_buttons_text', $cart_buttons_text_label, 'responsive_woocommerce_cart', 30, '#ffffff' );

			// Button Hover.
			$cart_buttons_hover_label = __( 'Button Hover', 'responsive' );
			responsive_color_control( $wp_customize, 'cart_buttons_hover', $cart_buttons_hover_label, 'responsive_woocommerce_cart', 40, '#0066CC' );

			// Button Hover Text.
			$cart_buttons_hover_text_label = __( 'Button Hover Text', 'responsive' );
			responsive_color_control( $wp_customize, 'cart_buttons_hover_text', $cart_buttons_hover_text_label, 'responsive_woocommerce_cart', 50, '#ffffff' );
			...
			responsive_color_control( $wp_customize, 'cart_checkout_button', $cart_checkout_button_label, 'responsive_woocommerce_cart', 70, '#0066CC' );

			// Button Text.
			$cart_checkout_button_text_label = __( 'Button Text', 'responsive' );
			responsive_color_control( $wp_customize, 'cart_checkout_button_text', $cart_checkout_button_text_label, 'responsive_woocommerce_cart', 80, '#ffffff' );

			// Button Hover.
			$cart_checkout_button_hover_label = __( 'Button Hover', 'responsive' );
			responsive_color_control( $wp_customize, 'cart_checkout_button_hover', $cart_checkout_button_hover_label, 'responsive_woocommerce_cart', 90, '#10659C' );

			// Button Hover Text.
			$cart_checkout_button_hover_text_label = __( 'Button Hover Text', 'responsive' );
			responsive_color_control( $wp_customize, 'cart_checkout_button_hover_text', $cart_checkout_button_hover_text_label, 'responsive_woocommerce_cart', 100, '#ffffff' );
