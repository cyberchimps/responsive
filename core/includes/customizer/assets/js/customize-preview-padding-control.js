...
( function( $ ) {
    ...
    api( 'responsive_product_card_outside_container_top_padding', function( value ) {
        value.bind( function( newval ) {
            responsive_dynamic_padding('product_card_outside_container', '.woocommerce-page ul.products li.product, .woocommerce ul.products li.product');
        } );
    } );
...
api( 'responsive_product_card_outside_container_tablet_bottom_padding', function( value ) {
    ...
    api( 'responsive_product_card_inside_container_top_padding', function( value ) {
        value.bind( function( newval ) {
            responsive_dynamic_margin('product_card_inside_container', '.woocommerce-page.responsive-site-style-boxed ul.products li.product, .woocommerce ul.products li.product');
        } );
    } );
    ...
    api( 'responsive_prodttom_padding', function( value ) {
        value.bind( function( newval ) {
            responsive_dynamic_margin('product_card_inside_container', '.woocommerce-page.responsive-site-style-boxed ul.products li.product, .woocommerce ul.products li.product');
        } );
    } );
...
api( 'responsive_product_card_inside_container_tablet_top_padding', function( value ) {
    value.bind( function( newval ) {
        responsive_dynamic_margin('product_card_inside_container', '.woocommerce-page ul.products li.product, .woocommerce ul.products li.product');
    } );
} );
