...
( function( $ ) {
	...
	api( 'responsive_top_bar_menu_items_padding_top_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_menu_items_padding', '.top-bar-navigation .topbar-menu > .menu-item > a');
		})
	});

	api( 'responsive_top_bar_menu_items_padding_bottom_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_menu_items_padding', '.top-bar-navigation .topbar-menu > .menu-item > a');
		})
	});

	api( 'responsive_top_bar_menu_items_padding_left_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_menu_items_padding', '.top-bar-navigation .topbar-menu > .menu-item > a');
		})
	});

	api( 'responsive_top_bar_menu_items_padding_right_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_menu_items_padding', '.top-bar-navigation .topbar-menu > .menu-item > a');
		})
	});

	// Top Bar Sub Menu Items Padding.
	api( 'responsive_top_bar_sub_menu_item_padding_top_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_sub_menu_item_padding', '.top-bar-navigation .topbar-menu .menu-item-has-children .sub-menu a');
		})
	});

	api( 'responsive_top_bar_sub_menu_item_padding_bottom_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_sub_menu_item_padding', '.top-bar-navigation .topbar-menu .menu-item-has-children .sub-menu a');
		})
	});

	api( 'responsive_top_bar_sub_menu_item_padding_left_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_sub_menu_item_padding', '.top-bar-navigation .topbar-menu .menu-item-has-children .sub-menu a');
		})
	});

	api( 'responsive_top_bar_sub_menu_item_padding_right_padding', function( value ) {
		value.bind( function( newval ) {
			responsive_dynamic_padding('top_bar_sub_menu_item_padding', '.top-bar-navigation .topbar-menu .menu-item-has-children .sub-menu a');
		})
	});
