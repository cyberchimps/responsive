...
( function( $ ) {
	...
	api( "body_typography[font-family]", function( $swipe ) {
		...
		$swipe.bind( function( pair ) {
			...
			if ( pair ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-font-family">.page .post-title{font-family: ' + pair + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-font-weight">.page .post-title{font-weight: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-font-style">.page .post-title{font-style: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-font-size">.page .post-title{font-size: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-tablet-font-size">@media (max-width: 768px){.page .post-title{font-size: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-mobile-font-size">@media (max-width: 480px){.page .post-title{font-size: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-color">.page .post-title{color: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-line-height">.page .post-title{line-height: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-tablet-line-height">@media (max-width: 768px){.page .post-title{line-height: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-mobile-line-height">@media (max-width: 480px){.page .post-title{line-height: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-letter-spacing">.page .post-title{letter-spacing: ' + dataAndEvents + "px;}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-tablet-letter-spacing">@media (max-width: 768px){.page .post-title{letter-spacing: ' + dataAndEvents + "px;}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-mobile-letter-spacing">@media (max-width: 480px){.page .post-title{letter-spacing: ' + dataAndEvents + "px;}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-page_title-text-transform">.page .post-title{text-transform: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
	   ...
	   $swipe.bind( function( pair ) {
	       ...
	       if ( pair ) {
	           /** @type {string} */
	           var img = '<style class="customizer-typography-blog_entry_title_typography-font-family">#primary .post .post-entry .entry-title a{font-family: ' + pair + ";}</style>";
	           if ( $child.length ) {
	               $child.replaceWith( img );
	           } else {
	               $( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-font-weight">#primary .post .post-entry .entry-title a{font-weight: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-font-style">#primary .post .post-entry .entry-title a{font-style: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-font-size">#primary .post .post-entry .entry-title a{font-size: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-tablet-font-size">@media (max-width: 768px){#primary .post .post-entry .entry-title a{font-size: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-mobile-font-size">@media (max-width: 480px){#primary .post .post-entry .entry-title a{font-size: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-color">#primary .post .post-entry .entry-title a{color: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-line-height">#primary .post .post-entry .entry-title a{line-height: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-tablet-line-height">@media (max-width: 768px){#primary .post .post-entry .entry-title a{line-height: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-mobile-line-height">@media (max-width: 480px){#primary .post .post-entry .entry-title a{line-height: ' + dataAndEvents + ";}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-letter-spacing">#primary .post .post-entry .entry-title a{letter-spacing: ' + dataAndEvents + "px;}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-tablet-letter-spacing">@media (max-width: 768px){#primary .post .post-entry .entry-title a{letter-spacing: ' + dataAndEvents + "px;}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-mobile-letter-spacing">@media (max-width: 480px){#primary .post .post-entry .entry-title a{letter-spacing: ' + dataAndEvents + "px;}}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
		...
		$swipe.bind( function( dataAndEvents ) {
			...
			if ( dataAndEvents ) {
				/** @type {string} */
				var img = '<style class="customizer-typography-blog_entry_title-text-transform">#primary .post .post-entry .entry-title a{text-transform: ' + dataAndEvents + ";}</style>";
				if ( $child.length ) {
					$child.replaceWith( img );
				} else {
					$( "head" ).append( img );
