wp.customize.controlConstructor['responsive-range'] = wp.customize.Control.extend({
	...
	ready: function() {
		...
		function responsive_autocorrect_range_input_number( input_number, timeout ) {
			...
			responsive_range_input_number_timeout = setTimeout( function() {
		...
		jQuery( 'input.responsive-range-input' ).on( 'change keyup', function() {
		...
		jQuery( '.responsive-reset-slider' ).on('click', function() {
