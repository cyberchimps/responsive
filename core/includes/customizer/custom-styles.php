...
.mobile-header-widgets .mobile-header-widgets-wrapper a:hover { color: {$mobile_header_widget_link_hover_color}; }";
	...
	.blog-entry-category *, .blog-entry-category a {
	...
	// Desktop border colors
	$header_primary_row_bottom_border_color = responsive_prepare_css_value( 'responsive_header_primary_row_bottom_border_color', Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_bottom_border_color' ) );
	$header_primary_row_bottom_border_hover_color = responsive_prepare_css_value( 'responsive_header_primary_row_bottom_border_color_hover', Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_bottom_border_hover_color' ) );
	...
	$header_below_row_bottom_border_color = responsive_prepare_css_value( 'responsive_header_below_row_bottom_border_color', Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_below_row_bottom_border_color' ) );
	...
	$above_footer_top_border_color     = responsive_prepare_css_value( 'responsive_footer_above_row_border_color', Responsive\Core\get_responsive_customizer_defaults( 'responsive_footer_below_row_border_color') );
	$above_footer_top_border_color_tablet = responsive_prepare_css_value( 'responsive_footer_above_row_border_color_tablet', $above_footer_top_border_color );
	$above_footer_top_border_color_mobile = responsive_prepare_css_value( 'responsive_footer_above_row_border_color_mobile', $above_footer_top_border_color );
