...
function responsive_customize_preview_js() {
	...
	// wp_enqueue_script( 'responsive_theme_lifter_customizer_drag_number', get_template_directory_uri() . '/core/includes/customizer/assets/js/lifter-customize-preview-drag-number-control.js', array( 'customize-preview' ), RESPONSIVE_THEME_VERSION, true );
}
