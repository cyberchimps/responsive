...
const BorderWidthDimensionsComponent = props => {
	let value = props.control.params;
	const [props_value, setPropsValue] = useState(value);

	const onConnectedClick = () => {
		let parent = event.target.parentElement.parentElement.parentElement;
		let inputs = parent.querySelectorAll('.responsive-border-width-dimensions-input');
...
export default React.memo( BorderWidthDimensionsComponent );
