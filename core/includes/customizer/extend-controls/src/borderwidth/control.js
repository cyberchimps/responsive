import BorderWidthDimensionsComponent from './border-width-dimensions-component.js';


export const responsiveBorderWidthDimensions = wp.customize.responsiveControl.extend( {
	renderContent: function renderContent() {
		let control = this;
	ReactDOM.render( <BorderWidthDimensionsComponent control={ control } />, control.container[0] );
	},
	ready: function() {
