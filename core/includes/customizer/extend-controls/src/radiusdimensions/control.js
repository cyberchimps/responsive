import RadiusDimensionsComponent from './radiusdimensions-component.js';


export const responsiveRadiusDimensions = wp.customize.responsiveControl.extend( {
	renderContent: function renderContent() {
		let control = this;
	ReactDOM.render( <RadiusDimensionsComponent control={ control } />, control.container[0] );
	},
	ready: function() {
