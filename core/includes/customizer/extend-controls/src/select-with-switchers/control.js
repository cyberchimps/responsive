import SelectWithSwitchersComponent from './select-with-switchers-component';

export const responsiveSelectWithSwitchers = wp.customize.responsiveControl.extend({
    renderContent: function renderContent() {
        let control = this;
        ReactDOM.render(<SelectWithSwitchersComponent control={control} />, control.container[0]);
    },
