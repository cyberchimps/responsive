import SelectButtonWithSwitchersComponent from './selectbtn-with-switchers-component';

export const responsiveSelectButtonWithSwitchers = wp.customize.responsiveControl.extend({
	renderContent: function renderContent() {
		let control = this;
		ReactDOM.render(<SelectButtonWithSwitchersComponent control={control} />, control.container[0]);
	},
	ready: function() {
		'use strict';
		let control = this;
