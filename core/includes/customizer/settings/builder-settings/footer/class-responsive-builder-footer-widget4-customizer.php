...
if ( ! class_exists( 'Responsive_Footer_Widget4_Customizer' ) ) :
	...
	class Responsive_Footer_Widget4_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			// Hide Widget4.
			$footer_widget4_hide_on_desktop = __( 'Hide on Desktop', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'footer_widget4_hide_on_desktop', $footer_widget4_hide_on_desktop, 'responsive_customizer_sidebar-widgets-footer-widget-4', 50, 0, null );
			$footer_widget4_hide_on_tablet = __( 'Hide on Tablet', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'footer_widget4_hide_on_tablet', $footer_widget4_hide_on_tablet, 'responsive_customizer_sidebar-widgets-footer-widget-4', 50, 0, null );
			$footer_widget4_hide_on_mobile = __( 'Hide on Mobile', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'footer_widget4_hide_on_mobile', $footer_widget4_hide_on_mobile, 'responsive_customizer_sidebar-widgets-footer-widget-4', 50, 0, null );
