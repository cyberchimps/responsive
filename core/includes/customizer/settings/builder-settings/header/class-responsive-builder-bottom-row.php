...
if ( ! class_exists( 'Responsive_Builder_Bottom_row' ) ) :
	...
	class Responsive_Builder_Bottom_Row {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_drag_number_control( $wp_customize, 'header_bottom_layout_container_width', $header_bottom_layout_container_width_label, 'responsive_customizer_header_bottom', 15, 2048, 'is_header_bottom_layout_contained', 4096, 1, 'postMessage' );
			...
			responsive_select_control( $wp_customize, 'bottom_row_border_top_style', $bottom_row_border_top_style_label, 'responsive_customizer_header_bottom', 70, $bottom_row_border_top_style_choices, 'none', null );
