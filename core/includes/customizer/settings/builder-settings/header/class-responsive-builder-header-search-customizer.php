...
if ( ! class_exists( 'Responsive_Header_Search_Customizer' ) ) :
	...
	class Responsive_Header_Search_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_text_control( $wp_customize, 'header_search_label', $header_search_label, 'responsive_customizer_header_search', 20, 'Search', null, 'sanitize_text_field', 'text', 'postMessage' );

			$header_search_label_visiblity_desktop = __( 'Header Search Label Visibility Desktop', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'header_search_label_visiblity_desktop', $header_search_label_visiblity_desktop, 'responsive_customizer_header_search', 25, 1, null, 'postMessage' );

			$header_search_label_visiblity_tablet = __( 'Header Search Label Visibility Tablet', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'header_search_label_visiblity_tablet', $header_search_label_visiblity_tablet, 'responsive_customizer_header_search', 30, 0, null, 'postMessage' );

			$header_search_label_visiblity_mobile = __( 'Header Search Label Visibility Mobile', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'header_search_label_visiblity_mobile', $header_search_label_visiblity_mobile, 'responsive_customizer_header_search', 35, 0, null, 'postMessage' );
			...
			responsive_select_control( $wp_customize, 'header_search_icon', $header_search_icon, 'responsive_customizer_header_search', 40, $header_search_icon_choices, 'search', null, 'postMessage' );
