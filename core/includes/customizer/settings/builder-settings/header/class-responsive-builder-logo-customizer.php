...
if ( ! class_exists( 'Responsive_Logo_Customizer' ) ) :
	...
	class Responsive_Logo_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_select_control( $wp_customize, 'desktop_logo_layout_structure', $desktop_logo_layout_structure_label, 'responsive_customizer_logo', 30, $logo_layout_structure_choices, 'standard', null );
			$tablet_logo_layout_structure_label = __( 'Tablet Logo Layout Structure', 'responsive' );
			responsive_select_control( $wp_customize, 'tablet_logo_layout_structure', $tablet_logo_layout_structure_label, 'responsive_customizer_logo', 35, $logo_layout_structure_choices, 'standard', null );
