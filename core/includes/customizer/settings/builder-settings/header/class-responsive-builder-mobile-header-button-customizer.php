...
if ( ! class_exists( 'Responsive_Mobile_mobile_Button_Customizer' ) ) :
	...
	class Responsive_Mobile_mobile_Button_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_text_control( $wp_customize, 'mobile_button_label', $mobile_button_label, 'responsive_customizer_mobile_button', 10, 'Button', null, 'sanitize_text_field', 'text', 'postMessage' );

			// Mobile Header Button Link.
			$mobile_button_link = __( 'Mobile Button URL', 'responsive' );
			responsive_text_control( $wp_customize, 'mobile_button_link', $mobile_button_link, 'responsive_customizer_mobile_button', 10, '', null, 'sanitize_text_field', 'text', 'postMessage' );

			// Mobile Header Button Target.
			$mobile_button_target = __( 'Mobile Open in New Tab', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'mobile_button_target', $mobile_button_target, 'responsive_customizer_mobile_button', 15, 0, null, 'postMessage' );

			// Mobile Header Button nofollow.
			$mobile_button_nofollow = __( 'Mobile Set link to nofollow', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'mobile_button_nofollow', $mobile_button_nofollow, 'responsive_customizer_mobile_button', 20, 0, null, 'postMessage' );

			// Mobile Header Button sponsored.
			$mobile_button_sponsored = __( 'Mobile Set link attribute Sponsored', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'mobile_button_sponsored', $mobile_button_sponsored, 'responsive_customizer_mobile_button', 25, 0, null, 'postMessage' );

			// Mobile Header Button download.
			$mobile_button_download = __( 'Mobile Set link to download', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'mobile_button_download', $mobile_button_download, 'responsive_customizer_mobile_button', 30, 0, null, 'postMessage' );
			...
			responsive_select_control( $wp_customize, 'mobile_button_size', $mobile_button_size, 'responsive_customizer_mobile_button', 35, $mobile_button_size_choices, 'medium', null, 'postMessage' );
			...
			responsive_select_control( $wp_customize, 'mobile_button_style', $mobile_button_style, 'responsive_customizer_mobile_button', 40, $mobile_button_style_choices, 'medium', null, 'postMessage' );
			...
			responsive_select_control( $wp_customize, 'mobile_button_visibility', $mobile_button_visibility, 'responsive_customizer_mobile_button', 45, $mobile_button_visibility_choices, 'everyone', null, 'postMessage' );
			...
			responsive_select_control( $wp_customize, 'mobile_button_border_style', $mobile_button_border_style_label, 'responsive_customizer_mobile_button', 55, $mobile_button_border_style_choices, 'solid', null, 'postMessage' );
