...
if ( ! class_exists( 'Responsive_Buttons_Customizer' ) ) :
	...
	class Responsive_Buttons_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_color_control( $wp_customize, 'button_text', $button_text_color_label, 'responsive_button', 20, Responsive\Core\get_responsive_customizer_defaults( 'responsive_button_text_color' ), null, '', true, Responsive\Core\get_responsive_customizer_defaults( 'button_hover_text' ), 'button_hover_text' );
