...
if ( ! class_exists( 'Responsive_Container_Spacing_Customizer' ) ) :
	...
	class Responsive_Container_Spacing_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_separator_control( $wp_customize, 'container_spacing', $container_spacing_label, 'responsive_layout', 60, 'This spacing applies to all pages and single product pages.', 'responsive_not_active_site_style_flat' );
