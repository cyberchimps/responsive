...
if ( ! class_exists( 'Responsive_Container_Spacing_Customizer' ) ) :
	...
	class Responsive_Container_Spacing_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_padding_control( $wp_customize, 'blog_inside_container', 'responsive_blog_layout', 270, 30, 30, 'responsive_not_active_site_style_flat', $outside_container_label, 'postMessage', 30, 30, 15, 15 );
