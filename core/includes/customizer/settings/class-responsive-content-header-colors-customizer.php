...
if ( ! class_exists( 'Responsive_Content_Header_Colors_Customizer' ) ) :
	...
	class Responsive_Content_Header_Colors_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_color_control( $wp_customize, 'breadcrumb', $breadcrumb_color_label, 'responsive_breadcrumb_layout', 70, Responsive\Core\get_responsive_customizer_defaults( 'breadcrumb' ), 'responsive_active_breadcrumb' );
