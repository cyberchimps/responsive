...
if ( ! class_exists( 'Responsive_Content_Header_Layout_Customizer' ) ) :
	...
	class Responsive_Content_Header_Layout_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			$wp_customize->add_section(
				'responsive_breadcrumb_layout',
				array(
					'title'    => esc_html__( 'Breadcrumb Settings', 'responsive' ),
					'panel'    => 'responsive_breadcrumb',
					'priority' => 15,
			...
			$wp_customize->add_control(
				new Responsive_Customizer_Checkbox_Control(
					...
					array(
						...
						'section'  => 'responsive_breadcrumb_layout',
			...
			responsive_select_control( $wp_customize, 'breadcrumb_position', $breadcrumb_position_label, 'responsive_breadcrumb_layout', 20, $breadcrumb_position_choices, 'before', 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on Home Page.
			$breadcrumb_disable_home_page = __( 'Disable on Home Page?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_home_page', $breadcrumb_disable_home_page, 'responsive_breadcrumb_layout', 20, 1, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on Blog / Posts Page.
			$breadcrumb_disable_blog_posts_page = __( 'Disable on Blog / Posts Page?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_blog_posts_page', $breadcrumb_disable_blog_posts_page, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on Search.
			$breadcrumb_disable_search = __( 'Disable on Search?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_search', $breadcrumb_disable_search, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on Archive?.
			$breadcrumb_disable_archive = __( 'Disable on Archive?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_archive', $breadcrumb_disable_archive, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on single page.
			$breadcrumb_disable_single_page = __( 'Disable on Single Page?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_single_page', $breadcrumb_disable_single_page, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on single post.
			$breadcrumb_disable_single_post = __( 'Disable on Single Post?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_single_post', $breadcrumb_disable_single_post, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on singular.
			$breadcrumb_disable_singular = __( 'Disable on Singular?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_singular', $breadcrumb_disable_singular, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );

			// Option: Disable Breadcrumb on 404 page.
			$breadcrumb_disable_404_page = __( 'Disable on 404 Page?', 'responsive' );
			responsive_checkbox_control( $wp_customize, 'breadcrumb_disable_404_page', $breadcrumb_disable_404_page, 'responsive_breadcrumb_layout', 20, 0, 'responsive_active_breadcrumb' );
			...
			responsive_padding_control( $wp_customize, 'content_header', 'responsive_breadcrumb_layout', 35, 30, 30, 'responsive_active_breadcrumb', $content_header_spacing_label );
