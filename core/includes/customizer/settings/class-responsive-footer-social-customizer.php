	...
	class Responsive_Footer_Social_Icons_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			$general_tab_ids = array(
				...
				$tab_ids_prefix . 'responsive_footer_social_redirect_to_social_links',
			);
			...
			responsive_redirect_control( $wp_customize, 'footer_social_redirect_to_social_links', __( 'Set Social Links', 'responsive' ), 'responsive_footer_social', 60, 'section', 'responsive_social_links');
