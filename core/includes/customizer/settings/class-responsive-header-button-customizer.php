...
if ( ! class_exists( 'Responsive_Header_Button_Customizer' ) ) :
	...
	class Responsive_Header_Button_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_horizontal_separator_control( $wp_customize, 'header_button_button_style_separator', 1, 'responsive_header_button', 55, 1 );
			...
			responsive_select_button_control( $wp_customize, 'header_button_size', __( 'Button Size', 'responsive' ), 'responsive_header_button', 54, $responsive_header_button_size, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_size' ), null );

			responsive_horizontal_separator_control( $wp_customize, 'header_button_size_separator', 1, 'responsive_header_button', 57, 1 );

			responsive_padding_control( $wp_customize, 'header_button', 'responsive_header_button', 56, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_padding_y' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_padding_x' ), 'responsive_show_header_button_padding', __( 'Padding', 'responsive' ) );

			responsive_horizontal_separator_control( $wp_customize, 'header_button_size_separator', 1, 'responsive_header_button', 57, 1, 'responsive_show_header_button_padding' );
			...
			responsive_select_button_control( $wp_customize, 'header_button_border_style', __( 'Border Style', 'responsive' ), 'responsive_header_button', 58, $responsive_header_button_border_style, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_border_style' ), null );

			responsive_drag_number_control( $wp_customize, 'header_button_border_width', __( 'Border Width', 'responsive' ), 'responsive_header_button', 58, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_border_width' ), 'responsive_show_header_button_border_option', 100, 1, 'postMessage' );

			responsive_color_control( $wp_customize, 'header_button_border', __( 'Border Color', 'responsive' ), 'responsive_header_button', 58, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_border_color' ), 'responsive_show_header_button_border_option', '', true, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_border_color_hover' ), 'header_button_border_hover' );

			responsive_horizontal_separator_control( $wp_customize, 'header_button_border_separator', 1, 'responsive_header_button', 58.5, 1 );

			responsive_radius_control( $wp_customize, 'header_button_radius', 'responsive_header_button', 59, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_radius_y' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_radius_x' ), null, __( 'Border Radius', 'responsive' ) );

			responsive_horizontal_separator_control( $wp_customize, 'header_button_radius_separator', 1, 'responsive_header_button', 60, 1 );

			responsive_typography_group_control( $wp_customize, 'header_button_typography_group', __( 'Font', 'responsive' ), 'responsive_header_button', 62, 'header_button_typography' );

			responsive_horizontal_separator_control( $wp_customize, 'header_button_typography_separator', 1, 'responsive_header_button', 63, 1 );

			responsive_padding_control( $wp_customize, 'header_button_margin', 'responsive_header_button', 64, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_margin_y' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_margin_x' ), '', __( 'Margin', 'responsive' ) );

			responsive_horizontal_separator_control( $wp_customize, 'header_button_margin_separator', 1, 'responsive_header_button', 65, 1 );

			responsive_shadow_control( $wp_customize, 'header_button_shadow', 'Button Shadow', 'responsive_header_button', 66, Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_shadow_x' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_shadow_y' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_shadow_blur' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_shadow_spread' ), Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_shadow_inset' ), null );
