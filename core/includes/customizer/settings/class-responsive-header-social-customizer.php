	...
	class Responsive_Header_Social_Icons_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			$design_tab_ids  = array(
				...
				$tab_ids_prefix . 'responsive_header_social_padding',
			...
			responsive_select_button_control( $wp_customize, 'header_social_item_border_style', __( 'Border Style', 'responsive' ), 'responsive_header_social', 75, $social_item_border_style_choices, 'solid', null, 'postMessage' );
			...
			responsive_padding_control( $wp_customize, 'header_social', 'responsive_header_social', 86, Responsive\Core\get_responsive_customizer_defaults( 'header_social_border_radius' ), Responsive\Core\get_responsive_customizer_defaults( 'header_social_border_radius' ), 'responsive_not_active_site_style_flat', __( 'Border Radius (px)', 'responsive' ) );
			...
			responsive_drag_number_control( $wp_customize, 'header_social_item_icon_size', __( 'Icon Size (px)', 'responsive' ), 'responsive_header_social', 89, 0, null, 200, 0, 'postMessage' );
