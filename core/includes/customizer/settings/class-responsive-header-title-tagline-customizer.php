...
if ( ! class_exists( 'Responsive_Header_Title_Tagline_Customizer' ) ) :
	...
	class Responsive_Header_Title_Tagline_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_separator_control( $wp_customize, 'header_site_title_separator', $site_title_separator_label, 'responsive_header_site_logo_title', 14 );
			...
			responsive_separator_control( $wp_customize, 'header_site_tagline_separator', $site_tagline_separator_label, 'responsive_header_site_logo_title', 15 );
