...
if ( ! class_exists( 'Responsive_Sidebar_Colors_Customizer' ) ) :
	...
	class Responsive_Sidebar_Colors_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_color_control( $wp_customize, 'sidebar_link', $sidebar_link_color_label, 'responsive_sidebar', 40, Responsive\Core\get_responsive_customizer_defaults( 'responsive_link_color' ), null, '', true, Responsive\Core\get_responsive_customizer_defaults( 'link_hover' ), 'sidebar_link_hover' );
