...
if (! class_exists('Responsive_Sidebar_Layout_Customizer')) :
    ...
    class Responsive_Sidebar_Layout_Customizer
    {
        ...
        public function customizer_options($wp_customize)
        {
            ...
            responsive_drag_number_control($wp_customize, 'page_sidebar_width', $page_sidebar_width_label, 'responsive_page', 26, 30, 'responsive_active_page_sidebar_position', 50, 20, 'postMessage');
