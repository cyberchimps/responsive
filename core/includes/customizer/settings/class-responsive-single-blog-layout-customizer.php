		...
		public function customizer_options( $wp_customize ) {
			...
			*/
			...
			if ( $wp_customize->get_control( 'responsive_comments_form_position' ) ) {
				$wp_customize->get_control( 'responsive_comments_form_position' )->note = __( 'You need at least one published comment on a post to see this effect in the live preview.', 'responsive' );
			}
