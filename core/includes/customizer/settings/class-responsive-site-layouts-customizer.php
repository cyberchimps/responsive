...
if ( ! class_exists( 'Responsive_Site_Layouts_Customizer' ) ) :
	...
	class Responsive_Site_Layouts_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			...
			responsive_imageradio_button_control( $wp_customize, 'width', $responsive_width_label, 'responsive_layout', 10, $responsive_width_choice, 'contained', null, 'png', 'postMessage' );
