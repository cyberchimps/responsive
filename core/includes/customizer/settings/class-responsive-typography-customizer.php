	...
	class Responsive_Typography_Customizer {
		...
		public function elements() {
			...
			$responsive_theme_typography_settings = array(
				...
				'secondary_button'           => array(
					'label'    => esc_html__( 'Body', 'responsive' ),
					'target'   => isset( $selectorArray['secondary_button'] ) ? $selectorArray['secondary_button'] : '.responsive-secondary-button',
					'section'  => 'responsive_button',
					'priority' => 314,
					'exclude'  => array( 'font-color' ),
					'defaults' => array(
		...
		public function getSelectorArray() {
			...
			$responsive_typography_selectors = array(
				...
				'secondary_button'           => '.responsive-secondary-button, .button-secondary, .wp-block-button.is-style-outline .wp-block-button__link',
