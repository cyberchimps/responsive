	...
	class Responsive_Typography_Customizer {
		...
		public function elements() {
			...
			$responsive_theme_typography_settings = array(
				...
				'rp_section_title'                     => array(
					'label'    => esc_html__( 'Typography', 'responsive' ),
					'target'   => $selectorArray['rp_section_title'],
				...
				'rp_post_title'                     => array(
					'label'    => esc_html__( 'Typography', 'responsive' ),
					'target'   => $selectorArray['rp_post_title'],
					'section'  => 'responsive_rp_layout',
					'exclude'  => array( 'font-color' ),
					'priority' => 32,
				),
				...
				'rp_content'                     => array(
					'label'    => esc_html__( 'Typography', 'responsive' ),
					'target'   => $selectorArray['rp_content'],
					'section'  => 'responsive_rp_layout',
					'exclude'  => array( 'font-color' ),
					'priority' => 34,
				),
				...
				'footer_social_item' => array(
					'label'    => esc_html__( 'Typography', 'responsive' ),
					'target'   => $selectorArray['footer_social'],
		...
		public function getSelectorArray() {
			...
			$responsive_typography_selectors = array(
				...
				'blog_breadcrumb' 			 => '.blog .breadcrumbs .breadcrumb-list',
				'page_breadcrumb'            => '.page .breadcrumbs .breadcrumb-list',
				'single_blog_post_text'      => '.single-post .entry-header *:not(.post-meta):not(.post-meta *):not(.post-title):not(.breadcrumbs *), .responsive-blog-single-banner2 .container *:not(.post-meta):not(.post-meta *):not(.post-title):not(.breadcrumbs *)',
