...
if( ! class_exists( 'Responsive_HFB_Footer_Above_Row' ) ) {
    ...
    class Responsive_HFB_Footer_Above_Row {
        ...
        public function customizer_options( $wp_customize ) {
			...
			responsive_drag_number_control( $wp_customize, 'footer_above_inner_column_spacing', $inner_column_spacing_label, 'responsive_footer_above_row', 50, 30, null, 300, 0, 'postMessage', 1 );
