...
if( ! class_exists( 'Responsive_HFB_Footer_Primary_Row' ) ) {
    ...
    class Responsive_HFB_Footer_Primary_Row {
        ...
        public function customizer_options( $wp_customize ) {
			...
			responsive_select_button_with_switchers_control( $wp_customize, 'footer_primary_width', $footer_primary_row_width_label, 'responsive_footer_primary_row', 10, $footer_primary_row_width_choices, 'contained', null, 'postMessage' );
