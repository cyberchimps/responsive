    ...
    class Responsive_HFB_Header_Primary_Row {
        ...
        public function customizer_options( $wp_customize ) {
			...
			responsive_color_control_with_device_switchers_and_hover( 
				$wp_customize, 
				'header_primary_row_bg', 
				$header_primary_row_color_label, 
				'responsive_header_primary_row', 
				30, 
				Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_bg_color' ),
				Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_bg_hover_color' ),
				null,
				'',
				'postMessage'
			);
            ...
            // Top Border Color.
			$header_primary_row_top_border_color_label = __( 'Top Border Color', 'responsive' );
			responsive_color_control_with_device_switchers_and_hover(
				$wp_customize,
				'header_primary_row_top_border',
				$header_primary_row_top_border_color_label,
				'responsive_header_primary_row',
				34,
				Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_top_border_color' ),
				Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_top_border_hover_color' ),
				null,
				'',
				'postMessage'
			);
			...
			responsive_color_control_with_device_switchers_and_hover(
				$wp_customize,
				'header_primary_row_bottom_border',
				$header_primary_row_bottom_border_color_label,
				'responsive_header_primary_row',
				40,
				Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_bottom_border_color' ),
				Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_primary_row_bottom_border_hover_color' ),
				null,
				'',
				'postMessage'
			);
            ...
            // Top Border Size.
            $header_primary_row_top_border_size_label = __( 'Top Border Size (px)', 'responsive' );
            responsive_drag_number_control_with_switchers( $wp_customize, 'header_primary_row_top_border_size', $header_primary_row_top_border_size_label, 'responsive_header_primary_row', 54, 0, null, 300, 0, 'postMessage', 1 );

            // Bottom Border Size.
            $header_primary_row_bottom_border_size_label = __( 'Bottom Border Size (px)', 'responsive' );
            responsive_drag_number_control_with_switchers( $wp_customize, 'header_primary_row_bottom_border_size', $header_primary_row_bottom_border_size_label, 'responsive_header_primary_row', 60, 1, null, 300, 0, 'postMessage', 1 );
			...
			$design_tab_ids = array(
				...
				$tab_ids_prefix . 'responsive_header_primary_row_top_border_color',
				...
				$tab_ids_prefix . 'responsive_header_primary_row_top_border_size',
			 ...
			 */
			$design_tab_ids = apply_filters( 'responsive_header_primary_row_design_tab_ids', $design_tab_ids );
