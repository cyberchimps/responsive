...
function cyberchimps_display_about()
{
	...
	<div class="about-container">
		...
		<div class="about-info">
			...
			<?php printf(
                __('<p>  is based on an intuitive foundation with a fluid grid system that automatically adapts your website to mobile devices including smartphones, tablets
				...
				We understand the importance of WordPress responsive themes and have ensured all of our themes are truly suitable for all mobile devices', 'responsive')
            ); ?>
		</div>
