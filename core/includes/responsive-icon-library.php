...
function responsive_get_svg_icon($icon_name) {
  $icons = array(
    ...
    'solid-border' => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" clip-rule="evenodd" viewBox="0 0 20 20" aria-hidden="true" focusable="false"><path d="M18.988 11.478V8.522H1.012v2.956h17.976z"></path></svg>',
    'dashed-border' => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" clip-rule="evenodd" viewBox="0 0 20 20" aria-hidden="true" focusable="false"><path d="M12.512 11.478V8.522H7.488v2.956h5.024zM14.004 8.522v2.956h4.984V8.522h-4.984zM1.012 8.522v2.956H6.05V8.522H1.012z"></path></svg>',
    'dotted-border' => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" clip-rule="evenodd" viewBox="0 0 20 20" aria-hidden="true" focusable="false"><circle cx="2.503" cy="10" r="1.487"></circle><circle cx="17.486" cy="10" r="1.487"></circle><circle cx="12.447" cy="10" r="1.487"></circle><circle cx="7.455" cy="10" r="1.487"></circle></svg>',
    'double-border' => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" clip-rule="evenodd" viewBox="0 0 20 20" aria-hidden="true" focusable="false"><path d="M1.02 6.561v2.957h17.968V6.561H1.02zM1.012 10.586v2.956H18.98v-2.956H1.012z"></path></svg>',
  );
