window.addEventListener( 'load', function(e) {
    ...
    setTimeout(() => {
        ...
        const googleFontsStyle = cloneLinkElement('responsive-google-font-'+responsiveBlockEditorData.fontHandle+'-css');
        ...
        for (const iframe of iframes) {
            try {
                ...
                if (iframeDoc?.head) {
                    appendLinkIfNotExists(iframeDoc, googleFontsStyle, 'responsive-google-font-'+responsiveBlockEditorData.fontHandle+'-css');
                }
            } catch {
