...
( function( $ ) {
    ...
    wp.customize( 'responsive_header_background_color', function( value ) {
    ...
    wp.customize( 'responsive_header_border_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_site_title_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_site_title_hover_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_widget_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_widget_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_widget_border_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_widget_link_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_widget_link_hover_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_alt_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Body text Color
    wp.customize( 'responsive_body_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //H2 text Color
    wp.customize( 'responsive_h2_text_color', function( value ) {
        value.bind( function( newval ) {
            $('h2').css('color', newval );
        } );
    } );
    ...
    //H3 text Color
    wp.customize( 'responsive_h3_text_color', function( value ) {
        value.bind( function( newval ) {
            $('h3').css('color', newval );
        } );
    } );
    ...
    //H4 text Color
    wp.customize( 'responsive_h4_text_color', function( value ) {
        value.bind( function( newval ) {
            $('h4').css('color', newval );
        } );
    } );
    ...
    //H5 text Color
    wp.customize( 'responsive_h5_text_color', function( value ) {
        value.bind( function( newval ) {
            $('h5').css('color', newval );
        } );
    } );
    ...
    //H6 text Color
    wp.customize( 'responsive_h6_text_color', function( value ) {
        value.bind( function( newval ) {
            $('h6').css('color', newval );
        } );
    } );
    ...
    //Link Color
    wp.customize( 'responsive_link_color', function( value ) {
        value.bind( function( newval ) {
            $('a').css('color', newval );
        } );
    } );
    ...
    //Link Hover Color
    wp.customize( 'responsive_link_hover_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Buttons color
    wp.customize( 'responsive_button_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Buttons text Color
    wp.customize( 'responsive_button_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_button_border_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Inputs color
    wp.customize( 'responsive_inputs_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Inputs text Color
    wp.customize( 'responsive_inputs_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    // Inputs border color
    wp.customize( 'responsive_inputs_border_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Labels Text Color
    wp.customize( 'responsive_label_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_active_menu_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_menu_link_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_sub_menu_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_sub_menu_link_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_header_menu_toggle_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Menu Toggle Color
    wp.customize( 'responsive_header_menu_toggle_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Background Color
    wp.customize( 'responsive_footer_background_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Title Color
    wp.customize( 'responsive_content_header_heading_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Description Color
    wp.customize( 'responsive_content_header_description_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Rating Color
    wp.customize( 'responsive_shop_product_rating_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Product Price Color
    wp.customize( 'responsive_shop_product_price_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Buttons Color
    wp.customize( 'responsive_add_to_cart_button_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Buttons Text
    wp.customize( 'responsive_add_to_cart_button_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Button Color
    wp.customize( 'responsive_cart_buttons_color', function( value ) {
        value.bind( function( newval ) {
    ...
    //Button Text Color
    wp.customize( 'responsive_cart_buttons_text_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_cart_checkout_button_color', function( value ) {
        value.bind( function( newval ) {
    ...
    wp.customize( 'responsive_cart_checkout_button_text_color', function( value ) {
        value.bind( function( newval ) {
