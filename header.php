...
<?php responsive_wrapper(); // before wrapper container hook. ?>
    ...
    <?php $responsive_blog_layout_columns = array("blog-2-col", "blog-3-col", "blog-4-col"); ?>

<?php
if ( ( isset( $responsive_options['site_layout_option'] ) && ( $responsive_options['site_layout_option'] == 'full-width-layout' ) && ( ! ( is_home() || is_front_page() ) ) ) || in_array($responsive_options['blog_posts_index_layout_default'], $responsive_blog_layout_columns) ){
	?>
<div id="content-outer" >
<?php } ?>
