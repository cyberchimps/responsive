...
$I->see('Comments');
$I->see('Date');
$I->click(_customizeLayoutPage::$TitleHideSelector);
$I->click(_customizeLayoutPage::$metahideSelector);
$I->click(_customizeLayoutPage::$ContentHideselector);
...
$I->dontSee('Template: Sticky');
$I->dontSee('Posted on');
$I->dontSee('Posted in');
$I->dontSee('This is a sticky post.');
