...
$I->click(_customizeLayoutPage::$SinglePostTitleicon);
$I->click(_customizeLayoutPage::$SinglePostMetaicon);
$I->click(_customizeLayoutPage::$SinglePostConteneticon);
$I->wait(10);
...
$I->dontSeeInSource('entry-title post-title responsive');
$I->dontSee('Posted in');
$I->dontSee('Posted on');
$I->dontSee('The Common category includes the following blocks: Paragraph, image, headings, list, gallery, quote, audio, cover, video.');
