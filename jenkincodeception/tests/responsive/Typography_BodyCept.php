...
$I->waitForElementVisible(_typographyBodyPage::$BodyTypographySelector,20);
$I->click(_typographyBodyPage::$BodyTypographySelector);
$I->waitForElementVisible(_typographyBodyPage::$FontStyleSelector,20);
...
$I->see(_typographyBodyPage::$Font_Size_Text);
...
$I->click(_typographyBodyPage::$FontStyleSelector);
...
$I->selectOption(_typographyBodyPage::$FontStyleSelector,_typographyBodyPage::$Italic_Font_Text);
$I->wait(5);
