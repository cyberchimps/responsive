...
$align        = get_theme_mod( 'footer_navigation_align', 'default' );
$tablet_align = get_theme_mod( 'footer_navigation_align', 'default' );
$mobile_align = get_theme_mod( 'footer_navigation_align', 'default' );

$valign        = get_theme_mod( 'footer_navigation_vertical_align', 'default' );
$tablet_valign = get_theme_mod( 'footer_navigation_vertical_align', 'default' );
$mobile_valign = get_theme_mod( 'footer_navigation_vertical_align', 'default' );
