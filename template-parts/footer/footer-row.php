...
$i = 0;
?>
<div class="rspv-site-<?php echo esc_attr( $row ); ?>-footer-wrap rspv-site-footer-focus-item rspv-hfb-footer-width-<?php echo esc_attr( $width ); ?> rspv-hfb-footer-row-<?php echo esc_attr( $inline_layout ); ?> <?php echo $has_mobile_items ? 'rspv-hfb-footer-has-mobile-items' : 'rspv-hfb-footer-no-mobile-items'; ?>" data-section="responsive-<?php echo esc_attr( $row ); ?>-footer-builder">
	<div class="container">
