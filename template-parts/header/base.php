...
<header id="masthead" class="site-header" role="banner" <?php responsive_schema_markup( 'site-header' ); ?>>
	<div id="main-header" class="site-header-wrap">
		<div class="site-header-inner-wrap<?php /* echo esc_attr( 'top_main_bottom' === responsive()->option( 'header_sticky' ) ? ' responsive-sticky-header' : '' ); */ ?>"
			<?php
			/*
			If ( 'top_main_bottom' === responsive()->option( 'header_sticky' ) ) {
		...
		>
			<div class="site-header-upper-wrap">
				<div class="site-header-upper-inner-wrap<?php /* echo esc_attr( 'top_main' === responsive()->option( 'header_sticky' ) ? ' responsive-sticky-header' : '' ); */ ?>"
					<?php
					/*
					If ( 'top_main' === responsive()->option( 'header_sticky' ) ) {
						echo ' data-reveal-scroll-up="' . ( responsive()->option( 'header_reveal_scroll_up' ) ? 'true' : 'false' ) . '"';
						echo ' data-shrink="' . ( responsive()->option( 'header_sticky_shrink' ) ? 'true' : 'false' ) . '"';
						if ( responsive()->option( 'header_sticky_shrink' ) ) {
							echo ' data-shrink-height="' . esc_attr( responsive()->sub_option( 'header_sticky_main_shrink', 'size' ) ) . '"';
