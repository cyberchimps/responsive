	...
	<div class="responsive-header-button-wrap">
		...
		<?php
			$href = get_theme_mod(
				...
				Responsive\Core\get_responsive_customizer_defaults('responsive_mobile_header_button_url')
			);
			...
			if (get_theme_mod('responsive_mobile_header_button_set_nofollow', Responsive\Core\get_responsive_customizer_defaults('responsive_mobile_header_button_set_nofollow'))) {
				$rel[] = 'nofollow';
			}
			if (get_theme_mod('responsive_mobile_header_button_set_sponsored', Responsive\Core\get_responsive_customizer_defaults('responsive_mobile_header_button_set_sponsored'))) {
				$rel[] = 'sponsored';
			}

			// Determine download attribute.
			$download = get_theme_mod('responsive_mobile_header_button_set_download', Responsive\Core\get_responsive_customizer_defaults('responsive_header_button_set_download')) ? 'download' : '';

			// Determine visibility.
			$header_button_visibility = get_theme_mod(
				'responsive_mobile_header_button_visibility',
			...
			$header_button_size = get_theme_mod( 'responsive_mobile_header_button_size', Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_button_size' ) );
			...
			if ($is_visible) {
				$button_label = get_theme_mod(
					...
					Responsive\Core\get_responsive_customizer_defaults('responsive_mobile_header_button_label')
				);
				?>
				<a 
					href="<?php echo $href; ?>" 
