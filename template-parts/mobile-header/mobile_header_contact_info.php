...
<div class="site-mobile-header-item site-header-focus-item" data-section="responsive_customizer_mobile_header_contact_info">
    ...
    $contact_icon_style = get_theme_mod( 'responsive_mobile_header_contact_info_icon_style', Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_contact_info_icon_style' ) );
    $contact_icon_shape = get_theme_mod( 'responsive_mobile_header_contact_info_icon_shape', Responsive\Core\get_responsive_customizer_defaults( 'responsive_header_contact_info_icon_shape' ) );
	?>
