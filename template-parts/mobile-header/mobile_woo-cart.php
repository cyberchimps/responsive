...
$cart_icon           = get_theme_mod( 'responsive_mobile_cart_icon', 'icon-opencart' );
 error_log('$cart_iconMOBBBB11111B=='.$cart_icon);
...
?>
<div class="site-mobile-header-item site-header-focus-item" data-section="responsive_mobile_header_woo_cart">
	<?php
        $output = '';
        ...
        // Icon selection uses the mobile-specific setting and applies regardless of Add-ons Pro status.
        ...
        $output .= '<div class="res-cart-link"><a href="' . esc_url( wc_get_cart_url() ) . '" class="cart-container"><div class="res-addon-mobile-cart-wrap res-mobile-cart-label-position-'. esc_attr( $cart_label_position ) .'">';
            ob_start();
            do_action( 'responsive_mobile_header_woo_cart_label_markup' );
	...
	?>
    <div class="responsive-mobile-header-cart rspv-header-cart-<?php echo esc_attr( $cart_click_action ) ?>"><?php echo $output; ?></div>
