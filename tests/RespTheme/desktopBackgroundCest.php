...
class desktopBackgroundCest
{
    ...
    // tests
    public function DesktopMainRowBackgroundSettings(RespThemeTester $I,  LogInAndLogOut $loginAndLogout, Customizer $customizer)
    {
        ...
        $I->wait(3);
        $I->click('/html/body/div[1]/form/div[3]/div[2]/div[2]/ul[55]/li[8]/label/div/div/button/span');
        $I->click('/html/body/div[1]/form/div[3]/div[2]/div[2]/ul[55]/li[8]/label/div/div/div/div[1]/div[1]/div[2]/div');
        $I->wait(2);
    }
}
