...
class desktopLayoutCest
{
    ...
    // tests
    public function DesktopLayoutSettings(RespThemeTester $I,LogInAndLogOut $loginAndLogout, Customizer $customizer)
    {
        ...
        $I->wait(3);
        $I->selectOption('/html/body/div[1]/form/div[3]/div[2]/div[2]/ul[55]/li[2]/select','Contained');
        $I->wait(2);
        $I->selectOption('/html/body/div[1]/form/div[3]/div[2]/div[2]/ul[55]/li[2]/select', 'Fullwidth');
        $I->wait(2);
    }
}
