...
class mobileminHeightCest
{
    ...
    // tests
    public function MobileMinHeightSettings(RespThemeTester $I, LogInAndLogOut $loginAndLogout, Customizer $customizer)
    {
        ...
        $I->wait(3);
        $I->fillField('/html/body/div[1]/form/div[3]/div[2]/div[2]/ul[55]/li[7]/label/div/input[2]','0');
        $I->wait(2);
    }
}
