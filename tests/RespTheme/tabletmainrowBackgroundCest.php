...
class tabletmainrowBackgroundCest
{
    ...
    public function tryToTest(RespThemeTester $I,LogInAndLogOut $loginAndLogout, Customizer $customizer)
    {
        ...
        $I->wait(3);
        $I->click('//*[@id="customize-control-responsive_main_row_background_tablet_color"]/label/div/div/button/span');
        $I->wait(2);
        $I->click('//*[@id="customize-control-responsive_main_row_background_tablet_color"]/label/div/div/div/div[1]/div[1]/div[2]/div');
        $I->wait(2);
    }
}
