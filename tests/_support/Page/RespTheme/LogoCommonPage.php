...
class LCommonPage
{
    ...
    public $ftitle = '//*[@id="main-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/p[1]';
    public $tTitle = '//*[@id="mobile-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/div[1]';
    public $mtitle = '//*[@id="mobile-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/div[1]';
    public $tSiteTitleHover = '//*[@id="mobile-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/div[1]';
    public $mSiteTitleHover = '//*[@id="mobile-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/div[1]';
    public $tabletTitle = '//*[@id="mobile-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/div[1]';
    /**
     * typography settings
     */
    public $typography = '//*[@id="main-header"]/div/div/div/div/div/div/div/div[1]/div/div/a/div/p[1]';
    /**
