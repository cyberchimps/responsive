...
class HeaderLayoutFullWidthHeaderCest
{
    ...
    public function tryToTest(CustomizerTester $I, AdminLogin $AdminLoginPage, Customizer $CustomizerPage, Home $HomaPage)
    {
        ...
        $I->amGoingTo('Check Default body Class without Full Width Header Checkbox checked');
        ...
        $I->dontSeeElement($HomaPage->bodyWithClass_FullWidthHeader);
        ...
        $I->wait(1);
        $I->seeElement($CustomizerPage->customizer_header_layout_Full_Width_Header);
        ...
        $I->expectTo('Dont See Body with Class '.$HomaPage->bodyWithClass_FullWidthHeader);
        ...
        //Open Customizer
        $I->amGoingTo('Going to enable Full Width Header');
        $I->click($CustomizerPage->customizer_header_layout_Full_Width_Header);
        ...
        $I->switchToIFrame("new_name");
        $I->seeElement($HomaPage->bodyWithClass_SiteHeaderSiteBrandingMainNavigation);
        $I->seeElement($HomaPage->bodyWithClass_FullWidthHeader);
        $I->seeElement($HomaPage->bodyWithClass_siteHeaderLayoutHorizontal);
        $I->seeElement($HomaPage->bodyWithClass_siteHeaderLayoutHorizontal);
        $I->seeElement($HomaPage->bodyWithClass_headerWidgetAlignmentSpread);
        $I->seeElement($HomaPage->bodyWithClass_headerWidgetPositionTop);
