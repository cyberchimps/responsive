...
class HeaderTypographyUpdateCustomizerValuesCest
{
    ...
    public function tryToTest(CustomizerTester $I, AdminLogin $AdminLoginPage, Customizer $CustomizerPage, Home $HomaPage)
    {
        ...
        $I->assertEquals('Times New Roman, sans-serif',$siteTaglineFontFamily);
        ...
        $I->assertEquals('Times New Roman, sans-serif',$siteTitleFontFamily);
