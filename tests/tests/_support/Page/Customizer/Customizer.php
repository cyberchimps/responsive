...
class Customizer
{
    ...
    public $customizer_header_typography_SiteTagline_FontFamily   ='#customize-control-header_site_title_typography-font-family > label > select';
    ...
    //Theme Options
    public $customizer_themeOptions                            = '#accordion-panel-responsive_site';
    //Theme Options Layout
    public $customizer_themeOptions_layout                     = '#accordion-section-responsive_layout';
    public $customizer_themeOptions_layout_width               = '#_customize-input-responsive_width';
    public $customizer_themeOptions_layout_containerWidth      = '#customize-control-responsive_container_width';
    public $customizer_themeOptions_layout_style               = '#_customize-input-responsive_style';
    public $customizer_themeOptions_layout_boxPadding          = '
    #customize-control-responsive_box_padding';
    public $customizer_themeOptions_layout_boxRadius           = '
    #customize-control-responsive_box_radius';
    public $customizer_themeOptions_layout_buttonsPadding      = '
    #customize-control-responsive_buttons_padding';
    public $customizer_themeOptions_layout_buttonsRadius       = '
    #_customize-input-responsive_buttons_radius';
    public $customizer_themeOptions_layout_buttonsBorderWidth  = '
    #_customize-input-responsive_buttons_border_width';
    public $customizer_themeOptions_layout_formInputsPadding   = '
    #customize-control-responsive_inputs_padding';
    public $customizer_themeOptions_layout_formInputsRadius    = '
    #_customize-input-responsive_inputs_radius';
    public $customizer_themeOptions_layout_formInputsBorderWidth= '
    #_customize-input-responsive_inputs_border_width';
